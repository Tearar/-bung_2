...
public class BaziCrypt {
    ...
    public static void decryptBaziCryptFiles() throws UnsupportedEncodingException {
        ...
        getEncryptionKeyFromPadding(baziFiles[1]);
    }
    ...
    private static void getEncryptionKeyFromPadding(byte[] cipher) throws UnsupportedEncodingException {
        ...
        /** for (int i = 80; i < 90; i++) {
         String hex = String.format("%02X", cipher[i]);
         System.out.println(hex);
         } **/
        System.out.println(keyPossibilities);
        keyPossibilityWithoutDuplicates = new ArrayList<>(
                new HashSet<>(keyPossibilities));
        System.out.println(keyPossibilityWithoutDuplicates);
    ...
    private static void readInBaziCryptFiles() {
        ...
        try {
            ...
            // String hex = String.format("%02X", baziFiles[2][2]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
